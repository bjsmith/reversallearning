...
#set settings.
models_to_run<-c("double_update_rpo_repeated_runs")
      ...
      for (em in estimation_methods){
        for (g in 2:3){
          ...
          fit<-lookupOrRunFit(
            ...
            fastDebug=FALSE,
            fileSuffix=paste0("20170927vb_retest_",as.character(t),generatePosteriorTrialPredictions=generatePosteriorTrialPredictions),
