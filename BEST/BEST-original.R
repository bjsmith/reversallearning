...
BESTsummary = function( y1 , y2 , mcmcChain ) {
  ...
  summaryInfo[ "mu1" , ] = mcmcSummary( mcmcChain[,"mu1"] )
  summaryInfo[ "mu2" , ] = mcmcSummary( mcmcChain[,"mu2"] )
  summaryInfo[ "muDiff" , ] = mcmcSummary( mcmcChain[,"mu1"]
                                           - mcmcChain[,"mu2"] , 
                                           compVal=0 )
  summaryInfo[ "sigma1" , ] = mcmcSummary( mcmcChain[,"sigma1"] )
  summaryInfo[ "sigma2" , ] = mcmcSummary( mcmcChain[,"sigma2"] )
  summaryInfo[ "sigmaDiff" , ] = mcmcSummary( mcmcChain[,"sigma1"]
                                              - mcmcChain[,"sigma2"] , 
                                              compVal=0 )
  ...
  effSzChain = ( ( mcmcChain[,"mu1"] - mcmcChain[,"mu2"] ) 
            / sqrt( ( mcmcChain[,"sigma1"]^2 + mcmcChain[,"sigma2"]^2 ) / 2 ) ) 
