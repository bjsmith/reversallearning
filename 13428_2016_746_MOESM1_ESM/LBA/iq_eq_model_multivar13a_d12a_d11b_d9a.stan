...
//v13: set data parameters for the cholesky and cauchy tuning to look at the influence of those variables on the end result.
...
model{
  ...
  L_Omega ~ lkj_corr_cholesky(cholesky_param);
  L_sigma ~ cauchy(0,cauchy_gamma); #these yield standard deviations of each individual value.
