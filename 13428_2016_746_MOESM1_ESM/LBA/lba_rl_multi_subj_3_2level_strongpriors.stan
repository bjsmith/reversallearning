...
model {
  ...
  subj_mu[PARID_alpha] ~ normal(-0,2);
  ...
  subj_sigma[PARID_alpha] ~ cauchy(0,3); //slightly more informative, narrow prior for distribution of subject-level alphas.
