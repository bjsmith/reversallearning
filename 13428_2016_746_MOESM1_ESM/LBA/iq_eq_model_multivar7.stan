...
transformed parameters{
  ...
  // matrix [K,K] trans_1 = [[L_Sigma[1,1],L_Sigma[2,1]],[L_Sigma[1,2],L_Sigma[2,2]]];
  // 
  // matrix [K,K] trans_2 = trans_1 * trans_1'; 
  // matrix [K,K] trans_3 = [[L_Sigma[1,1],L_Sigma[1,2]],[L_Sigma[2,1],L_Sigma[2,2]]];
  // matrix [K,K] trans_4 = trans_3 * trans_3';
  matrix [K,K] Sigma = L_Sigma * L_Sigma';
  // matrix [K,K] trans_6 = L_Sigma' * L_Sigma;
