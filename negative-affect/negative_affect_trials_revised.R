...
table(pain_data$Motivation)
pain_data[,mean(Value),by=.(ResponseCorrect,Motivation)]

ggplot(pain_data,aes(ResponseCorrect,Value,group=Motivation,color=Motivation))+
  geom_violin()+coord_cartesian(ylim=c(-600,0))
