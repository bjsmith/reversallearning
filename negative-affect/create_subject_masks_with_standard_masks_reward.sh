...
#		/expdata/xfgavin/MSM/sub113/data
		...
		then
			...
			#create link
			ln -s $SUBJECT_INPUT /expdata/bensmith/joint-modeling/data/msm/behavioral-analysis/reversallearning/preprocessed_fMRI_symlinks/sub${s}ReversalLearningRewardrun${r}.nii.gz
		fi
	done
done
