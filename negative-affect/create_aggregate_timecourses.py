...
def create_aggregate_timecourses(onsets,colsuffix):
    #identify the grouping factors.
...
onsets_convolved_agg=onsets_convolved.iloc[:,0:217].groupby(aggregate_rl_cols_as_in_fsl,axis=1).sum()
...
pandas.concat([sub113r1_fsl_staggered,neurolearn_onsets_staggered]).plot()
