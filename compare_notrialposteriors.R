...
#run.
summaryfilepath<-paste0(localsettings$data.dir,"comparedoubleUpdate_mcmc_notrialposteriors-FASTDEBUG.RData")
      ...
      for (em in estimation_methods){
        for (g in 2:3){
          ...
          fit<-lookupOrRunFit(
            ...
            fastDebug=TRUE,
            fileSuffix=paste0("20171004_mcmc_test_iteration_fastdebug_",as.character(t),"NA"),
          ...
          if(m=="double_update_rpo_repeated_runs"){
            ...
            "g"=g,"m"=m,"t"=t,"elapsedTime"=fit$general_info$estimation_duration)
