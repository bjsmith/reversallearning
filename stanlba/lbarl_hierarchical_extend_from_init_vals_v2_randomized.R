...
# fit_with_manual_init_vals <- run_model("lba_rl_multi_subj_7_3level_empiricalpriors_noncentered","G1_randomized_init_v2",
...
print("------------------------")
print("Running with RANDOM initial values, 10subs, full-group 1")
fit_with_manual_init_vals <- run_model("lba_rl_multi_subj_7_3level_empiricalpriors_noncentered","10subs_randomized_init_ad08_v2",
                                       filedir="incremental/",informative_priors = TRUE,
