...
fit_with_manual_init_vals <- run_model("lba_rl_multi_subj_7_3level_empiricalpriors_noncentered","informativepriors_10subjs_random_repeat",
                                       filedir="incremental/",informative_priors = TRUE,
                                       init_vals="randomized",warmup_iter = 450,iter=500)


print("------------------------")
print("Running the informative priors model WITH BOOTSTRAPPED INITIAL VALUES SPECIFIED.")
fit_with_manual_init_vals <- run_model("lba_rl_multi_subj_7_3level_empiricalpriors_noncentered","informativepriors_10subjs_bootstrapped_repeat",
                                       filedir="incremental/",informative_priors = TRUE,
...
fit_with_manual_init_vals <- run_model("lba_rl_multi_subj_7_3level_empiricalpriors_noncentered","informativepriors_10subjs_auto_repeat",
                                       filedir="incremental/",informative_priors = TRUE,
                                       init_vals="auto",warmup_iter = 450,iter=500)
