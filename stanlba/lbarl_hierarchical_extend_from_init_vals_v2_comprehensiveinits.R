...
fit_with_manual_init_vals <- run_model("lba_rl_multi_subj_7_3level_empiricalpriors_noncentered","10subs_empiricaldistribution_init_v2",
                                       filedir="incremental/",informative_priors = TRUE,
                                       init_vals="empirical_distribution",warmup_iter=16,iter=20,prior_blowup=1)
...
fit_with_manual_init_vals <- run_model("lba_rl_multi_subj_7_3level_empiricalpriors_noncentered","10subs_empiricaldistribution_init_v2",
                                       filedir="incremental/",informative_priors = TRUE,
                                       init_vals="empirical_distribution",warmup_iter=80,iter=100,prior_blowup=1)

print("------------------------")
print("Running with BOOTSTRAPPED initial values, 10subs, full-length")
fit_with_manual_init_vals <- run_model("lba_rl_multi_subj_7_3level_empiricalpriors_noncentered","10subs_empiricaldistribution_init_v2",
                                       filedir="incremental/",informative_priors = TRUE,
                                       init_vals="empirical_distribution",warmup_iter=80,iter=100,prior_blowup=100)
...
# fit_with_manual_init_vals <- run_model("lba_rl_multi_subj_7_3level_empiricalpriors_noncentered","10subs_empiricaldistribution_init_v2_ad08",
#                                        filedir="incremental/",informative_priors = TRUE,
#                                        init_vals="empirical_distribution",a_delta=0.8)
# 
# # 
# # print("------------------------")
# # print("Running with BOOTSTRAPPED initial values, 10subs, full-group 1")
# # fit_with_manual_init_vals <- run_model("lba_rl_multi_subj_7_3level_empiricalpriors_noncentered","G1_empiricaldistribution_init_v2",
# #                                        filedir="incremental/",informative_priors = TRUE,
# #                                        init_vals="empirical_distribution",data_to_use=multisubj_multirun_Group1,warmup_iter=5,iter=10)
# 
# load(paste0(
#   dd,"Fits/",
#   "lba_rl_multi_subj_7_3level_empiricalpriors_noncentered_10subs_empiricaldistribution_init_v2_run12_model_distinct_runs_itercount1000_wup500_MCMC.RData"
#   ))
# rmfit
# 
# load(paste0(
#   dd,"Fits/",
#   "lba_rl_multi_subj_7_3level_empiricalpriors_noncentered_10subs_empiricaldistribution_init_v2_ad08_run12_model_distinct_runs_itercount500_wup450_MCMC.RData"
# ))
# rmfit
