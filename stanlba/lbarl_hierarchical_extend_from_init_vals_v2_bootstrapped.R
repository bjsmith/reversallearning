...
fit_with_manual_init_vals <- run_model("lba_rl_multi_subj_7_3level_empiricalpriors_noncentered","G1_bootstrapped_init",
                                       ...
                                       init_vals="bootstrapped",data_to_use=multisubj_multirun_Group1,warmup_iter=5,iter = 10)
# 
# print("------------------------")
# print("Running with BOOTSTRAPPED initial values, 10subs, full-length")
# fit_with_manual_init_vals <- run_model("lba_rl_multi_subj_7_3level_empiricalpriors_noncentered","10subs_bootstrapped_init",
#                                        filedir="incremental/",informative_priors = TRUE,
...
# print("------------------------")
# print("Running with BOOTSTRAPPED initial values, 10subs, full-group 1")
# fit_with_manual_init_vals <- run_model("lba_rl_multi_subj_7_3level_empiricalpriors_noncentered","10subs_bootstrapped_init_ad08",
#                                        filedir="incremental/",informative_priors = TRUE,
