...
model_lba_rl_joint_v10e$results_summary_dt<-data.table(model_lba_rl_joint_v10e$results_summary)
...
run_data_report(model_lba_rl_joint_v10e$results_summary_dt)
stop("this has already been done ovr at lba_rl_evaluate_joint_model_rpe")
