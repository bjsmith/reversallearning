select_rawdata_cols_for_run<-function(rawdata,sid,r,m){
  return(rawdata[subid==sid & Motivation==m & runid==r,
                 .(reaction_time,outcome,cue,choice,cor_res_Counterbalanced,presentation_n_over_run,
                   #ACC
...
create_standatalist<-function(srm.data,n_back=3){
  ...
  list(
    ...
    cue=srm.data$cue,
    presentation_order=srm.data$presentation_n_over_run,
    n_back=n_back,
