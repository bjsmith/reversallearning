...
model_lba_rl_joint_v11s<-single_level_model_summarize_fast(
  ...
  model_subversion="s")
#seems to be very patchy, timing out occasionally and more often, failing to fully converge.
model_lba_rl_joint_v11s$results_summary_dt<-data.table(model_lba_rl_joint_v11s$results_summary)
...
model_lba_rl_joint_v11t<-single_level_model_summarize_fast(
  ...
  model_subversion="t")
#better
model_lba_rl_joint_v11t$results_summary_dt<-data.table(model_lba_rl_joint_v11t$results_summary)
