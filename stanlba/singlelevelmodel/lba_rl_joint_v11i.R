#So: cauchy at 0, 1 seems to not converge on a a straightforward result with iter=300,warmup=200. This may be a problem.
...
model.name<-"lba_rl_single_exp_joint_v11_priorsamplejoint"
cat("Compiling model...")
