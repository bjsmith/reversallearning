...
run_data_report(model_lba_rl_joint_v11s)
...
delta_names<- freesurfer_region_naming(get_dmn_regions())

STD<-t.test.report(model_lba_rl_joint_v11s$results_summary_dt,
              theta_names=theta_names,
              delta_names=delta_names)

write.csv(STD,"lba_rl_joint_v11s_sigma_theta_delta.csv")
