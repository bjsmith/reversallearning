...
//v10: restores using the RPE of the *particular item chosen* rather than consistently the second item. This way RPE will primarily measure whether they got something right vs. wrong, but better than measuring just the second choice, which is weird.
//    also uses an empirical value rather than an estimate of the td_mean
functions{
