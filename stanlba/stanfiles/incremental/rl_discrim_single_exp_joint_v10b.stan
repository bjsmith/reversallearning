//v10b: does a sum for the log likelihood excluding the mixture model itself, which might be a better comparison for the control.
//v10a: corrects a mistake in calculating likelihood
