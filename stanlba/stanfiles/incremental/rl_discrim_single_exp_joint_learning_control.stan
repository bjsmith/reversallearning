//rl_discrim_single_exp_joint_learning_control
//modified from discrim v10a, which was a mixture model, but functionally removes the discrimination componentry
//while retaining basic learning capabilities.
