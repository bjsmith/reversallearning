...
//v21 uses a simple correlation matrix to estimate the relationships between values, rather than a covariance matrix. based on test file called lkj7.stan.
functions{
...
parameters {
  ...
  // ////////////\begin{joint model machinery}
  //vector[TD_N] td_mu;
  cholesky_factor_corr[TD_N] L_Sigma;
...
transformed parameters {
  ...
  corr_matrix[TD_N] Sigma = multiply_lower_tri_self_transpose(L_Sigma);
  // ////////////\end{joint model machinery}
