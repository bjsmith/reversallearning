...
model {
  ...
  for (i in 1:LENGTH){//loop through timesteps.
    ...
    //for the second model, let's assume that the more the participant has seen a stimulus, the more they are familiar with it.
    //or maybe, the more strong their expectation, the more strongly they weight towards this item rather than another one.
    //we assume familiarity tracks expectancy certainty.
