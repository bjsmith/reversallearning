...
fit_weakly_informative_priors <- run_model("lba_rl_multi_subj_7_3level_empiricalpriors_noncentered","10subs_30iter_weakpriors",filedir="incremental/",informative_priors = FALSE)
# 
