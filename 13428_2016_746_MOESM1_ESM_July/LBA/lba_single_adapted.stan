functions{
     real lba_pdf(real t, real b, real A, real v, real s){
          ...
          //whether we make these normal_lpdf or normal_lcdf, pdf still ends up above 1 many times...
          //so I don't think this is >1 because I made a mistake. This is by design or it's a mistake on the original authors.
          term_2 = s*exp(normal_lpdf(b_A_tv_ts | 0, 1)); //term_2 = s*exp(normal_log(b_A_tv_ts,0,1)); 
          term_3 = v*Phi(b_tv_ts);
          term_4 = s*exp(normal_lpdf(b_tv_ts | 0, 1)); //term_4 = s*exp(normal_log(b_tv_ts,0,1)); 
