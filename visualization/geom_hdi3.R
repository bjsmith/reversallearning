...
#'
#' \if{html}{
#' A sample of the output from \code{geom_hdi()}:
#'
#' \figure{geomhdi01.png}{options: width="100\%" alt="Figure: geomhdi01.png"}
#' }
#'
#' \if{latex}{
#' A sample of the output from \code{geom_hdi()}:
#'
#' \figure{geomhdi01.png}{options: width=10cm}
#' }
#'
#' @section Aesthetics:
...
#'   geom_point(color="black") +
#'   geom_smooth(se=FALSE, linetype="dashed", size=0.5) +
#'   geom_hdi(spline_shape=-0.4, size=0.5)
#'
#' ggplot(dat, aes(x, y, group=group, color=factor(group))) +
#'   geom_point(color="black") +
#'   geom_smooth(se=FALSE, linetype="dashed", size=0.5) +
...
#'   geom_point(color="black") +
#'   geom_smooth(se=FALSE, linetype="dashed", size=0.5) +
#'   geom_hdi(spline_shape=1, size=0.5)
#'
#' ggplot(dat, aes(x, y, group=group, color=factor(group))) +
#'   geom_point(color="black") +
#'   geom_smooth(se=FALSE, linetype="dashed", size=0.5) +
#'   geom_hdi(spline_shape=0, size=0.5)
#'
#' ggplot(dat, aes(x, y, group=group, color=factor(group))) +
#'   geom_point(color="black") +
#'   geom_smooth(se=FALSE, linetype="dashed", size=0.5) +
...
#' @keywords internal
#' @export
GeomHdi <- ggproto("GeomHdi", GeomLine,
                       required_aes = c("x", "y"),
...
#'   \item{y}
#' }
stat_hdi <- function(mapping = NULL, data = NULL, geom = "line",
