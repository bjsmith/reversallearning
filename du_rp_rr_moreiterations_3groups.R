#Purposes:
#1) Examine differences between all three subject groups.
...
summaryfilepath<-paste0(localsettings$data.dir,"additional_iterations_3groups_20171016.RData")
      ...
      for (m in models_to_run){
        for (g in subject_groups){
          ...
          fitpackage<-lookupOrRunFit(
            ...
            fastDebug=FALSE,
            #Not going to change this code, so that I can take advantage of all the values that have already come past and just draw them together.
