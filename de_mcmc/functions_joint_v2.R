...
crossover=function(i,pars,use.theta,use.like,use.data,use.mu,use.Sigma,use.phi){
...
if (file.exists(paste0(dataDir,subDir))){
...
write(round(use.phi[q,],6),paste("chain",q,"_hyper.txt",sep=""),ncolumns=n.hpars,append=append)
