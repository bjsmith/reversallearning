    ...
    for(tr in 1:nt){#tr=1;tr=tr+1
      ...
      if (use.data[[s]]$choice[tr]!=0) {
        ...
        ev[use.data[[s]]$cue[tr],3-use.data[[s]]$choice[tr]] = 
          ev[use.data[[s]]$cue[tr],3-use.data[[s]]$choice[tr]] + as.numeric(x[[paste0("alpha_s",s)]]) * PEnc;
        ev[use.data[[s]]$cue[tr],use.data[[s]]$choice[tr]] = 
          ev[use.data[[s]]$cue[tr],use.data[[s]]$choice[tr]] + as.numeric(x[[paste0("alpha_s",s)]]) * PE;
