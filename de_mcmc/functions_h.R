...
wrapper=function(use.theta,use.like,log.dens,use.data,prior,...)migrate(use.theta=array(use.theta,c(n.chains,n.pars)),use.like=use.like,log.dens=log.dens,use.data=use.data,prior=prior,...)
