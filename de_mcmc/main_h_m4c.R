...
g1_subs<-which(unlist(lapply(data,function(d){d$group=="Safe No Meth"})))
g2_subs<-which(unlist(lapply(data,function(d){d$group=="Risky No Meth"})))
g3_subs<-which(unlist(lapply(data,function(d){d$group=="Risky Meth"})))
