...
range<-(migrate.duration-round(tnmc/10)):(migrate.duration+round(tnmc/10))
#range<-1:tnmc
lnmc=length(range)
...
plot.output.filename<-paste(save.dir,save.name,"migration_end.pdf",sep="")
pdf(plot.output.filename,10,6)
