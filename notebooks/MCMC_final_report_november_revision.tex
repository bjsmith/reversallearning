...
\begin{Highlighting}[]
\CommentTok{# }
\CommentTok{# dens=sum(dnorm(x_s[par.ids.l1[["alpha"]]],}
\CommentTok{#                use.phi[par.ids.l2[["alpha_mu"]]],}
\CommentTok{#                use.phi[par.ids.l2[["alpha_sigma"]]],log=TRUE)) + }
\CommentTok{#     sum(dnorm(x_s[par.ids.l1[["thresh"]]],}
\CommentTok{#               use.phi[par.ids.l2[["thresh_mu"]]],}
\CommentTok{#               use.phi[par.ids.l2[["thresh_sigma"]]],log=TRUE)) +}
\CommentTok{#     sum(dnorm(x_s[par.ids.l1[["tau"]]],}
\CommentTok{#               use.phi[par.ids.l2[["tau_mu"]]],}
\CommentTok{#               use.phi[par.ids.l2[["tau_sigma"]]],log=TRUE)) }
\CommentTok{#   }
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# dens=0}
\CommentTok{# }
\CommentTok{# ev=matrix(0,100,2)}
\CommentTok{# v_t=matrix(0,nt,2)}
\CommentTok{# }
\CommentTok{# alpha_tr<-f_alpha_s_tr(as.numeric(x_s[which(par.names=="alpha")]))}
\CommentTok{# for(tr in 1:use.data_s$choice)\{}
\CommentTok{#   if (use.data_s$choice[tr]!=0) \{}
...
\CommentTok{#     v_t[tr,]=invlogit(ev[use.data_s$cue[tr],])}
\CommentTok{#     }
\CommentTok{#     # prediction error}
\CommentTok{#     PE   =  use.data_s$outcome[tr] - ev[use.data_s$cue[tr],use.data_s$choice[tr]]}
\CommentTok{#     PEnc = -use.data_s$outcome[tr] - ev[use.data_s$cue[tr],3-use.data_s$choice[tr]]}
\CommentTok{#     }
\CommentTok{#     # value updating (learning)}
\CommentTok{#     ev[use.data_s$cue[tr],3-use.data_s$choice[tr]] = }
\CommentTok{#       ev[use.data_s$cue[tr],3-use.data_s$choice[tr]] + alpha_tr * PEnc;}
\CommentTok{#     ev[use.data_s$cue[tr],use.data_s$choice[tr]] = }
\CommentTok{#       ev[use.data_s$cue[tr],use.data_s$choice[tr]] + alpha_tr * PE;}
\CommentTok{#     }
\CommentTok{#   \}}
\CommentTok{# \}}
\CommentTok{# }
\CommentTok{# thresh_s_tr<-f_thresh_s_tr(x_s[which(par.names=="thresh")])}
\CommentTok{# tau_s_tr<-f_tau_s_tr(x_s[which(par.names=="tau")] )}
\CommentTok{# }
\CommentTok{# dens.2choice=}
\CommentTok{#   log(wald.pdf.raw(t[idx1],alpha[1],v[idx1,1],theta[1])*}
\CommentTok{#         (1-wald.cdf.raw(t[idx1],alpha[2],v[idx1,2],theta[2]))) + }
\CommentTok{#   log(wald.pdf.raw(t[idx2],alpha[2],v[idx2,2],theta[2])*}
\CommentTok{#         (1-wald.cdf.raw(t[idx2],alpha[1],v[idx2,1],theta[1])))}
\CommentTok{# }
\CommentTok{# dens=dens+dens.2choice}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/graph_diagnostic_data_1-1.pdf}

\includegraphics{MCMC_final_report_november_revision_files/figure-latex/graph_diagnostic_data_2-1.pdf}

\includegraphics{MCMC_final_report_november_revision_files/figure-latex/graph_diagnostic_data_3-1.pdf}
...
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/h_m3_reward_run2_graphing_distributions-1.pdf}

\includegraphics{MCMC_final_report_november_revision_files/figure-latex/h_m3_reward_run2_graphing_distributions_sigma-1.pdf}
...
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/graph_diagnostic_data_subs-1.pdf}

\includegraphics{MCMC_final_report_november_revision_files/figure-latex/graph_diagnostic_data_subs_graph-1.pdf}

\includegraphics{MCMC_final_report_november_revision_files/figure-latex/graph_diagnostic_data_subs_graph_sigma-1.pdf}
...
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/ggplot_res_graph_by_motivation_stat-1.pdf}

We can examine the difference between the Meth and NoMeth groups using
the following graph.

\includegraphics{MCMC_final_report_november_revision_files/figure-latex/MethMinusNoMethByMotivation-1.pdf}
...
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/MethMinusNoMethAcrossMotivations-1.pdf}
...
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/h_m3_reward_run2 graphing_chains-1.pdf}
...
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_firstset-1.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_firstset-2.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_firstset-3.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_firstset-4.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_firstset-5.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_firstset-6.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_firstset-7.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_firstset-8.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_firstset-9.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_firstset-10.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_firstset-11.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_firstset-12.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_firstset-13.pdf}

\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-1.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-2.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-3.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-4.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-5.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-6.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-7.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-8.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-9.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-10.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-11.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-12.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-13.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-14.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-15.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-16.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-17.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-18.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-19.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-20.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-21.pdf}
\includegraphics{MCMC_final_report_november_revision_files/figure-latex/main_h_m5j_3l_model_graph_secondset-22.pdf}
