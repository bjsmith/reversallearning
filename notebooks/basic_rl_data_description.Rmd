...
ggplot(rl.all.subjects.list.g1g2g3[response_key!=0 | response_key > 1], aes(reaction_time))+
  geom_histogram(binwidth=0.05)+
  scale_y_continuous(trans="log10")

```
In a simple reaction time task, \textcite{woods2015factors} found subjects' simple response time had a mean of 213 ms, including movement initiation. In their analysis, they coded responses less than 110~ms as a false alarm. Here, I followed their practice by marking trials with responses less than 110~ms as non-response trials. Of the 
