...
```{r model_run, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r VisualizeIterationConsistency, echo=TRUE, message=FALSE, warning=FALSE,cache=TRUE, fig.cap=TRUE}
...
```{r CompareVBAndMCMCReliability, echo=TRUE, message=FALSE, warning=FALSE,cache=TRUE, fig.cap=TRUE}
source("visualization/geom_hdi.R")
m.mu.run1<-model.summary.all[Motivation=="Punishment" & Statistic=="mu" & Run==1]
#table(m.reward.mu.run1$ModelName)
#for clarity's sake...
...
```{r CompareVBvsMCMCReliability2, echo=TRUE, message=FALSE, warning=FALSE,cache=TRUE, fig.cap=TRUE}
source("visualization/geom_hdi.R")
m.mu.run1<-model.summary.all[Motivation=="Punishment" & Statistic=="mu" & Run==1]
#table(m.reward.mu.run1$ModelName)
#for clarity's sake...
