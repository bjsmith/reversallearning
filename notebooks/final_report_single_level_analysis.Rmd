...
load("/expdata/bensmith/joint-modeling/data/msm/reversallearning/lba_rl/joint_20180709_1/lba_rl_single_exp_joint_v11s_rsdt.RData")
...
results_raw<-data.table(read.csv("/expdata/bensmith/joint-modeling/data/msm/reversallearning/lba_rl/joint_20180709_1/lba_rl_single_exp_joint_v11s_revised.csv"))
...
#from lba_rl_evaluate_joint_model_rpe_ev
...
ggplot(results.ev.present,
  ...
  labs(title="Estimated mean correlation\nof regions with Expected Value\n across subjects",
       y="Estimated mean correlation",
       color="p < 0.05",
       caption="Color-codes indicate a significant difference from zero at the FRD-corrected 0.05 level")
...
region_correlation_strength_4_deltas<-data.table(read.csv("/expdata/bensmith/joint-modeling/data/msm/reversallearning/lba_rl/joint_20180709_1/lba_rl_single_exp_joint_v11t_revised.csv"))
